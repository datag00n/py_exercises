...
def usage():
    ...
    #print
    #print "Examples:"
    #print "nc.py -t 10.10.10.1 -p 5555 -l -c"
    #print "nc.py -t 10.10.10.1 -p 5555 -l -u=c:\\target.exe"
    #print "echo 'ABCDEFGHI' | ./NetMEow.py -t 192.168.11.12 -p 135"
    sys.exit(0)
...
def run_command(command):
				...
				#send the output back to the clientreturn output
...
def client_handler(client_socket):
		...
		if len(upload_destination):
				...
				#read in all of the bytes and write out destination
				file_buffer = ""

				#keep refreshing data until none is available
				while True:
